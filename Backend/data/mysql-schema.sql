...
(
  'laptop',
  'Laptop',
  'https://modelviewer.dev/assets/ShopifyModels/Laptop.glb',
  JSON_ARRAY('laptop', 'computer', 'notebook', 'pc', 'personal computer', 'macbook'),
  'A sleek, modern laptop computer with a visible screen, keyboard, and trackpad, ideal for workspace, office, or technology scenes.'
),
(
  'astronaut',
  'Astronaut',
